...
Public Class Album
    ...
    Private _release_date As String
    Private _popularity As Integer

    <JsonProperty("album_type")> Public Property album_type() As String
        Get
            Return _album_type
        End Get
        Set(value As String)
    ...
    <JsonProperty("uri")> Public Property uri() As String
        ...
        End Set
    End Property
    <JsonProperty("release_date")> Public Property release_date() As String
        Get
